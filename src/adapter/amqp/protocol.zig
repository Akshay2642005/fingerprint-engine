...
test "amqp: frame and header" {
...

    {
        ...
        try testing.expectEqualSlices(
            u8,
            &.{ 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x0a, 0xce },
            buffer[0..encoder.index],
        );
    }

    {
        ...
        try testing.expectEqualSlices(
            u8,
            &.{
                0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x0a, 0x00, 0x64, 0xce,
                0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x0a, 0x00, 0x00, 0x00,
...

    {
        ...
        try testing.expectEqualSlices(
            u8,
            &.{
                0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x64, 0x03, 0xe8, 0xce,
                0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x64, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0xce, 0x03, 0x00, 0x01, 0x00,
                0x00, 0x00, 0x04, 0x62, 0x6f, 0x64, 0x79, 0xce,
            },
            buffer[0..encoder.index],
        );
    }
