//! AMQP 0-9-1 method declarations: tagged unions of client/server methods
//! with their wire encoding. Derived mechanically from the AMQP 0-9-1
//! specification; treat as generated code (the structure mirrors the
//! published spec XML, so edits here should be rare and deliberate).
